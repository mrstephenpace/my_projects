...
class BBoxVisualization():
    ...
    def draw_bboxes(self, img, box, conf, cls, cam):
        ...
        #for i in range(len(box)):
            ...
            avg_width = 4.0
            dist = distance_to_camera(avg_width, focalLength, int(x_max-x_min))

            # display distance of hand to camera
            color = (255,0,0)
            cv2.putText(img, 'distance: '+str("{0:.2f}".format(dist)+' inches'),
            (int(width*0.7),int(height*0.9+30*i)),
